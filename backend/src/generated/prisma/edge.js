...
exports.Diffculty = exports.$Enums.Diffculty = {
  EASY: 'EASY',
  MEDIUM: 'MEDIUM',
  HARD: 'HARD'
};
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/hassanraza/LeetLab/backend/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/hassanraza/LeetLab/backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://myuser:myleetlab@localhost:5432/postgres"
      }
    }
  },
